...
public class SetFilePermissionHelper {
    ...
    private static final Set<AclEntryPermission> DEFAULT_PERMISSIONS = EnumSet.of(AclEntryPermission.DELETE, // Permission
                                                                                                             // to
                                                                                                             // delete
                                                                                                             // the
                                                                                                             // file.
            AclEntryPermission.DELETE_CHILD, // Permission to delete a file or
                                             // directory within a directory.

            AclEntryPermission.WRITE_DATA, // Permission to modify the file's
                                           // data.
            AclEntryPermission.WRITE_ATTRIBUTES, // The ability to write
                                                 // (non-acl) file attributes.
            AclEntryPermission.WRITE_NAMED_ATTRS, // Permission to write the
                                                  // named attributes of a file.
            AclEntryPermission.APPEND_DATA, // Permission to append data to a
                                            // file.
            AclEntryPermission.SYNCHRONIZE, // Permission to access file locally
                                            // at the server with synchronous
                                            // reads and writes.

            AclEntryPermission.READ_ATTRIBUTES, // The ability to read (non-acl)
                                                // file attributes.
            AclEntryPermission.READ_DATA, // Permission to read the data of the
                                          // file.
            AclEntryPermission.READ_NAMED_ATTRS, // Permission to read the named
    ...
    public Path createFileWithPermission(String path, boolean isLogDir,
            final Set<AclEntryPermission> user_chosen_permissions, AclEntryType aclEntryType)
            throws DatabaseOperationException {
        ...
        // If file already exists and it is not logs folder, confirm for
    ...
    private static final class DSFileAttributes implements FileAttribute<List<AclEntry>> {
        ...
        public List<AclEntry> value() {
            ...
            // select ACL flags
            Set<AclEntryFlag> flags = EnumSet.of(AclEntryFlag.FILE_INHERIT, // Can
                                                                            // be
                                                                            // placed
                                                                            // on
                                                                            // a
                                                                            ...
                                                                            // file
                                                                            // created.
                    AclEntryFlag.DIRECTORY_INHERIT // Can be placed on a
                                                   // directory and indicates
                                                   // that the ACL entry should
            ...
            builder.setType(SetFilePermissionHelper.aclEntryType);// Explicitly
                                                                  // grants
                                                                  // access to a
                                                                  // file or
                                                                  // directory
