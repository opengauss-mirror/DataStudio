...
public class CommonLLTUtilsHelper
{
            ...
            PreparedStatementResultSetHandler preparedstatementHandler)
    {
        ...
        preparedstatementHandler.prepareResultSet(CommonLLTUtilsHelper.FETCH_ALL_NAMESPACE_LOAD_PRIV, getNamespaceInfo);
        preparedstatementHandler.prepareResultSet(CommonLLTUtilsHelper.FETCH_ALL_NAMESPACE_LOAD_ALL, getNamespaceInfo);
        ...
        MockResultSet namespaceRS111 = preparedstatementHandler.createResultSet();
        namespaceRS111.addColumn("oid");
        namespaceRS111.addColumn("nspname");
        namespaceRS111.addRow(new Object[] {3, "PUBLIC"});
        namespaceRS111.addRow(new Object[] {1, "pg_catalog"});
        namespaceRS111.addRow(new Object[] {2, "information_schema"});
        preparedstatementHandler.prepareResultSet(
                CommonLLTUtilsHelper.FETCH_ALL_NAMESPACE_LOAD_PRIV, namespaceRS111);
        MockResultSet namespaceRS1111 = preparedstatementHandler.createResultSet();
        namespaceRS1111.addColumn("oid");
        namespaceRS1111.addColumn("nspname");
        namespaceRS1111.addRow(new Object[] {3, "PUBLIC"});
        namespaceRS1111.addRow(new Object[] {1, "pg_catalog"});
        namespaceRS1111.addRow(new Object[] {2, "information_schema"});
        preparedstatementHandler.prepareResultSet(
                CommonLLTUtilsHelper.FETCH_ALL_NAMESPACE_LOAD_ALL, namespaceRS1111);
            ...
            PreparedStatementResultSetHandler preparedstatementHandler)
    {
        ...
        preparedstatementHandler.prepareResultSet(
                "SELECT c.oid, n.oid as nspoid, n.nspname AS schemaname, c.relname AS viewname, pg_get_userbyid(c.relowner) AS viewowner "
                        + "FROM (pg_class c LEFT JOIN pg_namespace n ON ((n.oid = c.relnamespace))) WHERE (c.relkind = 'v'::\"char\") ",
                getdbsrs);
    }
