...
public class CommonLLTUtilsHelper
{
    ...
    public static final String  GET_ALL_NAMESPACE         = "SELECT oid, nspname from pg_namespace where nspname  NOT LIKE 'pg_toast%' and nspname NOT LIKE 'pg_temp%' ORDER BY nspname;";
