package com.huawei.mppdbide.mock.adapter;
...
public class ExceptionConnection extends MockConnection
{
	...
	boolean throwExceptionisClosed=false;

    public void setThrowExceptionisClosed(boolean throwExceptionisClosed) {
        this.throwExceptionisClosed = throwExceptionisClosed;
    }
