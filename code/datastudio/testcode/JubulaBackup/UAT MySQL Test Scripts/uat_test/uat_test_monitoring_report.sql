...
LOCK TABLES `monitoring_report` WRITE;
/*!40000 ALTER TABLE `monitoring_report` DISABLE KEYS */;
/*!40000 ALTER TABLE `monitoring_report` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-04-18 17:29:26
