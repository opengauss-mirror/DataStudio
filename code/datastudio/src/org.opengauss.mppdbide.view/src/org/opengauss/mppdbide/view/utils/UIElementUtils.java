...
public class UIElementUtils {
    ...
    private static final String SNIPPET_STACK_ID = "org.opengauss.mppdbide.view.partstack.visualsnippet";

    private static final String CONSOLE_PARTSTACK_ID = "org.opengauss.mppdbide.partstack.id.console";

    private static final String OBJECTBROWSER_PARTSTACK_ID = "org.opengauss.mppdbide.partstack.id.objectbrowser";
    ...
    public String setNewPartProperties(IDebugObject debugObject, String id, String label, String toolTip,
        ...
        newpart.setToBeRendered(true);
        newpart.setVisible(true);
        newpart.setContributionURI("bundleclass://org.opengauss.mppdbide.view/org.opengauss.mppdbide.view.ui.PLSourceEditor");
        newpart.setCloseable(true);
        newpart.setOnTop(true);
