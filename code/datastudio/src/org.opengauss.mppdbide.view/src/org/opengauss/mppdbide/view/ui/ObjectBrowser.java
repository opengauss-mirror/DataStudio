...
import org.opengauss.mppdbide.view.core.LoadingUIElement;
import org.opengauss.mppdbide.view.core.ObjectBrowserContentProvider;
import org.opengauss.mppdbide.view.core.ObjectBrowserLabelProvider;
import org.opengauss.mppdbide.view.core.ObjectBrowserLazyContentProvider;
...
import org.opengauss.mppdbide.view.handler.ConnectToDB;
import org.opengauss.mppdbide.view.handler.DisconnectDatabase;
import org.opengauss.mppdbide.view.handler.ExecuteObjectBrowserItem;
import org.opengauss.mppdbide.view.handler.RefreshObjectBrowserItem;
...
/**
 * Title: class Description: The Class ObjectBrowser.
 *
 * @since 3.0.0
 */
public class ObjectBrowser implements Observer, ObjectBrowserIf {
    ...
    public void createPartControl(Composite parent, EPartService partService, EMenuService menuService,
        ...
        MPart mpart = partService.findPart("org.opengauss.mppdbide.part.id.objectbrowser");
        MUIElement ele = modelService.cloneSnippet(application, "org.opengauss.mppdbide.view.part.common", null);
    ...
    private class RefreshItemSelectionListener implements SelectionListener {
        ...
        public void widgetSelected(SelectionEvent event) {
            Command command = commandService.getCommand("org.opengauss.mppdbide.command.id.refreshserverobject");
    ...
    private class SearchItemSelectionListener implements SelectionListener {
        ...
        public void widgetSelected(SelectionEvent event) {
            ...
            Command command = commandService.getCommand("org.opengauss.mppdbide.view.command.search");
            ParameterizedCommand parameterizedCommand = ParameterizedCommand.generateCommand(command, null);
            handlerService.executeHandler(parameterizedCommand);
    ...
    /**
     * Title: class Description: The Class TreeviwerHelper.
     */
    ...
    private void initDebugObjects() {
        Command command = commandService.getCommand("org.opengauss.mppdbide.command.id.viewsourceobjectbrowseritem");
        ParameterizedCommand parameterizedCommand = ParameterizedCommand.generateCommand(command, null);
        handlerService.executeHandler(parameterizedCommand);
    }
