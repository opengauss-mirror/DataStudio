...
import org.opengauss.mppdbide.view.core.sourceeditor.ErrorAnnotationMarkerAccess;
...
import org.opengauss.mppdbide.view.core.sourceeditor.SQLEditorPlugin;
...
import org.opengauss.mppdbide.view.filesave.DirtyTerminalDialog;
import org.opengauss.mppdbide.view.handler.ExecuteEditorItem;
import org.opengauss.mppdbide.view.handler.OpenSQLHandler;
import org.opengauss.mppdbide.view.handler.SaveSQLAsHandler;
import org.opengauss.mppdbide.view.handler.SaveSQLHandler;
import org.opengauss.mppdbide.view.prefernces.DBAssistantOption;
import org.opengauss.mppdbide.view.prefernces.DSTransactionPreferencePage;
...
import org.opengauss.mppdbide.view.ui.IDEStartup;
import org.opengauss.mppdbide.view.ui.QueryInfo;
import org.opengauss.mppdbide.view.ui.SqlHistory;
...
import org.opengauss.mppdbide.view.utils.MultiCheckSelectionCombo;
...
public class SQLTerminal extends AbstractAutoSaveObject implements ISaveablePart, SQLTerminalAutoSaveIf {
    ...
    public boolean isVisualPlanEnabled() {
        Command cmd = EclipseInjections.getInstance().getCommandService()
                .getCommand("org.opengauss.mppdbide.view.command.visualexplainplan");
    ...
    public boolean isExecutionPlanEnabled() {
        ...
        Command cmd = EclipseInjections.getInstance().getCommandService()
                .getCommand("org.opengauss.mppdbide.command.id.executionplanandcost");
        ParameterizedCommand parameterizedCmd = new ParameterizedCommand(cmd, null);
        if (EclipseInjections.getInstance().getHandlerService().canExecute(parameterizedCmd)) {
            return true;
        }
    ...
    private void addFindMenuItem(Menu menu) {
        ...
        menuFind.addSelectionListener(new SelectionListener() {
            ...
            public void widgetSelected(SelectionEvent e) {
                Command cmd = commandService.getCommand("org.opengauss.mppdbide.command.id.findandreplace");
                ParameterizedCommand parameterizedCmd = new ParameterizedCommand(cmd, null);
    ...
    private void addExecutionPlanMenuItem(Menu menu) {
        ...
        menuExecutionPlan.addSelectionListener(new SelectionListener() {
            @Override
            public void widgetSelected(SelectionEvent e) {
                Command cmd = commandService.getCommand("org.opengauss.mppdbide.command.id.executionplanandcost");
                ParameterizedCommand parameterizedCmd = new ParameterizedCommand(cmd, null);
                handlerService.executeHandler(parameterizedCmd);
            }
    ...
    private class VisualPlanBtnSelectionListener implements SelectionListener {
        ...
        @Override
        public void widgetSelected(SelectionEvent e) {
            Command command = commandService.getCommand("org.opengauss.mppdbide.view.command.visualexplainplan");
    ...
    private class ExecutionPlanSelectionListener implements SelectionListener {
        ...
        public void widgetSelected(SelectionEvent e) {
            ...
            Command command = commandService.getCommand("org.opengauss.mppdbide.command.id.executionplanandcost");
            Map<String, String> parameters = new HashMap<String, String>(MPPDBIDEConstants.OBJECT_ARRAY_SIZE);
            parameters.put("org.opengauss.mppdbide.view.commandparameter.explainplan.terminal.id", uiID);
            parameters.put("org.opengauss.mppdbide.view.commandparameter.explainplan.analyze", analyzeFlag);
            ParameterizedCommand parameterizedCommand = ParameterizedCommand.generateCommand(command, parameters);
            handlerService.executeHandler(parameterizedCommand);
        }
    ...
    public void handleExecution() {
        Command command = commandService
                .getCommand("org.opengauss.mppdbide.command.id.executeobjectbrowseritemfromtoolbar");
        Map<String, String> parameters = new HashMap<String, String>(MPPDBIDEConstants.OBJECT_ARRAY_SIZE);
    ...
    public void handleExecutionNewTab() {
        Command command = commandService
                .getCommand("org.opengauss.mppdbide.command.id.executeobjectbrowseritemfromtoolbarnewtab");
        Map<String, String> parameters = new HashMap<String, String>(MPPDBIDEConstants.OBJECT_ARRAY_SIZE);
        parameters.put("terminal.id", uiID);
    ...
    private static final class SelectionListenerHelper implements SelectionListener {
        ...
        @Override
        public void widgetSelected(SelectionEvent e) {
            Command cmd = cmdService.getCommand("org.opengauss.mppdbide.command.id.cancelSql");
            ParameterizedCommand parameterizedCmd = new ParameterizedCommand(cmd, null);
    ...
    public void savePart() {
        ...
        if (isFileTerminalFlag()) {
            handlerService.executeHandler(commandService.createCommand("org.opengauss.mppdbide.command.id.savesql", null));
        }
    }
