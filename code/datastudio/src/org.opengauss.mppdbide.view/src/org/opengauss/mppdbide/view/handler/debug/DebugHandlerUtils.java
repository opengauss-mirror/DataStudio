...
public class DebugHandlerUtils {
    ...
    public void showAllDebugView(boolean isShow) {
        String partId = "org.opengauss.mppdbide.partsashcontainer.id.sub.alldebug";
    ...
    public void initDebugSourceView() {
        ...
        String viewCommand = "org.opengauss.mppdbide.command.id.viewsourceobjectbrowseritem";
