...
import org.opengauss.mppdbide.view.ui.ExecutionPlanHandler;
...
public class ExecutionPlanAndCost {
    ...
    @Execute
    public void execute(
            @Optional @Named("org.opengauss.mppdbide.view.commandparameter.explainplan.terminal.id") String terminalID,
            @Optional @Named("org.opengauss.mppdbide.view.commandparameter.explainplan.analyze") String analyzeFlag,
            Shell shell) {
