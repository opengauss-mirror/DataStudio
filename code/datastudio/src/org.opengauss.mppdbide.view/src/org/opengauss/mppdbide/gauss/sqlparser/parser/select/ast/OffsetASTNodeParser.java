...
/**
 * Title: OffsetASTNodeParser
 * 
 * @since 3.0.0
 */
public class OffsetASTNodeParser extends LimitASTNodeParser {
    ...
    public String getKeywordTokenStr() {
        return SQLFoldingConstants.SQL_KEYWORD_OFFSET;
    }
