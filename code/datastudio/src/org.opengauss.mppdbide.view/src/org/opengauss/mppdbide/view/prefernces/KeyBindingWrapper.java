...
public final class KeyBindingWrapper {
    ...
    private static final String CODETEMLPLATECOMMANDID = "org.opengauss.mppdbide.editor.shortcutmapper.codetemplate";
    ...
    private ParameterizedCommand addParametersToCommand(String commandStrng, Command command) {
        if (commandStrng.equals("org.opengauss.mppdbide.command.id.executeobjectbrowseritemfromtoolbarnewtab")) {
