 ...
 * Title: class
 * 
 * Description: The Class DSEditTableDataGridRow.
 * 
 * @since 3.0.0
 */
public class DSEditTableDataGridRow extends DSResultSetGridDataRow implements IDSGridEditDataRow {
    ...
    private DSEditTableDataGridDataProvider dataProvider;
     ...
     * @param dataProvider the data provider
     */
    public DSEditTableDataGridRow(DSEventTable eventTable, DSEditTableDataGridDataProvider dataProvider) {
        super(dataProvider);
        this.eventTable = eventTable;
