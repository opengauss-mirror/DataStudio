...
public class CommonLLTUtilsHelper
{
    ...
    public static final String  GET_ALL_NAMESPACE         = "SELECT oid, nspname from pg_namespace where nspname  NOT LIKE 'pg_toast%' and nspname NOT LIKE 'pg_temp%' and has_schema_privilege(nspname, 'USAGE') ORDER BY nspname;";
            ...
            PreparedStatementResultSetHandler preparedstatementHandler)
    {
        ...
        dbrs.addRow(new Object[] {2, "bigint", 1, 1, "character", true, "type",
