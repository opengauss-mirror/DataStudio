...
import org.opengauss.mppdbide.bl.serverdatacache.DebugObjects.DebugObjectsUtils.GenerateExecutionTemplateParameter;
...
public class DebugObjects extends BatchDropServerObject implements ObjectChange, GaussOLAPDBMSObject, IDebugObject {
    ...
    public String generateDropQuery() {
        ...
        if (returnType != null && "trigger".equalsIgnoreCase(returnType.getDataType())) {
            cascade = true;
        }
