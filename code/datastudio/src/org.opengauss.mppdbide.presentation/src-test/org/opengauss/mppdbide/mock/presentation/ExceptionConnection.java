...
public class ExceptionConnection extends MockConnection
{
    ...
    private boolean isExceptionFromUser;
    ...
    public PreparedStatement prepareStatement(String arg0) throws SQLException,IndexOutOfBoundsException
    {
        ...
        else if(needExceptioStatement)
        {
            ...
            if (needExecuteException)
            {
                exceptionPreparedStatement.setNeedExecuteException(true);
                if (isSetException())
                {
                    exceptionPreparedStatement.setExp(sqlException);
                }
            }
    ...
    private boolean isSetException()
    {
        return isExceptionFromUser();
    }
    ...
    public boolean isExceptionFromUser()
    {
        return isExceptionFromUser;
    }

    public void setExceptionFromUser(boolean isExceptionFromUser)
    {
        this.isExceptionFromUser = isExceptionFromUser;
    }
}
