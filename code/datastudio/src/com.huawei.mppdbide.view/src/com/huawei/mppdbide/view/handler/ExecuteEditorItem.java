...
/**
 * Title: class Description: The Class ExecuteEditorItem. Copyright (c) Huawei
...
public class ExecuteEditorItem implements ExecuteWrapper {
    ...
    public void execute() {
        ...
        if (null == editor) {
            Command command = commandService.getCommand("com.huawei.mppdbide.command.id.executeobjectbrowseritem");
