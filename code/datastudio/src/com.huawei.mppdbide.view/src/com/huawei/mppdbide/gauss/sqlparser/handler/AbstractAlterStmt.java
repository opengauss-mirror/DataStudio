 ...
 * @since 3.0.0
 */
public class AbstractAlterStmt {
     ...
     */
    public boolean isStopParentScriptBlock(ScriptBlockInfo curBlock, SQLToken token) {
     ...
     */
    public boolean isNested(ScriptBlockInfo curBlock, SQLToken token) {
        return false;
    }
