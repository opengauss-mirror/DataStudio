...
/**
 * 
 * Title: LimitASTNodeParser
 *
 * @since 3.0.0
 */
public class LimitASTNodeParser extends BasicASTNodeParser {
    ...
    protected void prepareASTOtherStmtObject(ListIterator<ISQLTokenData> listIterator, TBasicASTNode fromAstNode) {
        TLimitASTNode lTLimitASTNode = (TLimitASTNode) fromAstNode;
        TExpression parseAndGetExpression = NodeExpressionConverter.parseAndGetExpression(listIterator,
                getKeywordList());
        lTLimitASTNode.setLimitExpression(parseAndGetExpression);
    }
    ...
    public String getKeywordTokenStr() {
        return SQLFoldingConstants.SQL_KEYWORD_LIMIT;
    }
