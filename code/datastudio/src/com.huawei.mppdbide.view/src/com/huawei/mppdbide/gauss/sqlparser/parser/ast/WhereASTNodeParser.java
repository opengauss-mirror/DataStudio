...
/**
 * Title: WhereASTNodeParser
 * 
 * @since 3.0.0
 */
public class WhereASTNodeParser extends BasicASTNodeParser {
    ...
    public String getKeywordTokenStr() {
        return SQLFoldingConstants.SQL_KEYWORD_WHERE;
    }
