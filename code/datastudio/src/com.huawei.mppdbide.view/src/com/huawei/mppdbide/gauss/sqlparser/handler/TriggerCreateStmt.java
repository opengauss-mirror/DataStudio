...
/**
 * Title: TableCreateStmt Description: Copyright (c) Huawei Technologies Co.,
 * Ltd. 2012-2019.
 *
 * @author S72444
 ...
 * @since 19-Aug-2019
 */
public class TriggerCreateStmt extends AbstractCreateStmt<DMLParamScriptBlockInfo> {
    /**
    ...
    public boolean isNested(DMLParamScriptBlockInfo curBlock, SQLToken token) {
        if (token.getType() == SQLTokenConstants.T_SQL_BLOCK_BEGIN
